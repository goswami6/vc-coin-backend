...
const ensureDashboardTables = async () => {
  const tables = [
    ...
    `CREATE TABLE IF NOT EXISTS sell_orders (id INT AUTO_INCREMENT PRIMARY KEY, seller_id INT, buyer_id INT, vc_amount DECIMAL(16,4) DEFAULT 0, price_per_vc DECIMAL(16,4) DEFAULT 0, total_price DECIMAL(16,2) DEFAULT 0, status VARCHAR(20) DEFAULT 'pending', createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP)`,
